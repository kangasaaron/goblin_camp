...
const  Trait = { // enum
	FRESH: Symbol('Trait.FRESH'),
	CHICKENHEART: Symbol('Trait.CHICKENHEART'),
	VETERAN: Symbol('Trait.VETERAN'),
	BOSS: Symbol('Trait.BOSS'),
	CRACKEDSKULL: Symbol('Trait.CRACKEDSKULL')
};

const  Skill = { // enum
	MASONRY: Symbol('Skill.MASONRY'),
	CARPENTRY: Symbol('Skill.CARPENTRY'),
	SKILLAMOUNT: Symbol('SkillSKILLAMOUNT').
};
