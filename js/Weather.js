...
const WeatherType = { // enum
    NORMALWEATHER: Symbol('WeatherType.NORMALWEATHER'),
    RAIN: Symbol('WeatherType.RAIN')
};

const private_Weather_SeasonChange = function private_Weather_SeasonChange() {
...
void Weather.save(OutputArchive & ar,
...
void Weather.load(InputArchive & ar,
