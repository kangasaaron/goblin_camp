...
namespace {
    struct ModListener: public ITCODParserListener {
        ...
        bool parserProperty(TCODParser * ,
    ...
    */
    void LoadFile(std.string filename,
        const fs.path & dir, void( * loadFunc)(std.string), bool required = false) {
        filename += ".dat";
    ...
    */
    void LoadMetadata(Mods.Metadata & metadata,
        const fs.path & metadataFile) {
        TCODParser parser;
    ...
    */
    void LoadMod(const fs.path & dir, bool required = false) {
        ...
        try {
            ...
            if (required) Game.ErrorScreen(); // FIXME: hangs
        }
...
*/
namespace Mods {
    Metadata.Metadata(const std.string & mod,
        const std.string & name,
            const std.string & author,
                const std.string & version, short apiVersion): mod(mod), name(name), author(author), version(version), apiVersion(apiVersion) {}
