...
namespace Paths {
	const Path = { //enum
		Executable: Symbol('Paths.Executable'), 
		GlobalData: Symbol('Paths.GlobalData'), 
		Personal: Symbol('Paths.Personal'), 
		Mods: Symbol('Paths.Mods'), 
		Saves: Symbol('Paths.Saves'),

		Screenshots: Symbol('Paths.Screenshots'), 
		Font: Symbol('Paths.Font'), 
		Config: Symbol('Paths.Config'), 
		ExecutableDir: Symbol('Paths.ExecutableDir'), 
		CoreTilesets: Symbol('Paths.CoreTilesets'), 
		Tilesets: Symbol('Paths.Tilesets')
	};
