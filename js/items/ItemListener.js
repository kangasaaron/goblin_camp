...
import { ItemCat } from "./ItemCat.js";
...
export class ItemListener extends PresetParser {
    ...
    constructor(store, filename) {
        super(filename);
        /** @type {Map} */
        this.presetGrowth = new Map();
        /** @type {Map} */
        this.presetFruits = new Map();
        /** @type {Map} */
        this.presetDecay = new Map();
        /** @type {Map} */
        this.presetProjectile = new Map();
        /** @type {Map} */
        this.presetCategoryParent = new Map();
        /** @type {int} */
        this.itemIndex = 0;
        /** @type {int} */
    ...
    parserNewStruct(str, nm) {
        ...
        if (nm && str.name === "category_type") {
            if (this.Item.itemCategoryNames.find(strName) !== this.Item.itemCategoryNames.end()) {
                ...
                this.Item.itemCategoryNames.insert(std.make_pair(strName, Game.i.ItemCatCount - 1));
            ...
            if (this.Item.itemTypeNames.has(strName)) {
                ...
                ++Game.i.ItemTypeCount;
                this.Item.Presets[this.Item.Presets.length - 1].name = nm;
                this.Item.itemTypeNames.set(strName, Game.i.ItemTypeCount - 1);
    ...
    parserProperty(nm, value) {
        ...
        if (name, "category") {
            ...
            this.Item.Presets[this.itemIndex].nutrition = Math.round(value * Constants.MONTH_LENGTH);
