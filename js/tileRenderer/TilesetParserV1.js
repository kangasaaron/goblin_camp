...
class TileSetParserV1 extends /*public*/ ITCODParserListener, private boost.noncopyable {
    ...
    const SpriteSet = // enum
        {
            SS_NONE: Symbol('SpriteSet.SS_NONE'),
            SS_NPC: Symbol('SpriteSet.SS_NPC'),
            SS_ITEM: Symbol('SpriteSet.SS_ITEM'),
            SS_NATURE: Symbol('SpriteSet.SS_NATURE'),
            SS_CONSTRUCTION: Symbol('SpriteSet.SS_CONSTRUCTION'),
            SS_SPELL: Symbol('SpriteSet.SS_SPELL')
        };
...
class TileSetMetadataParserV1 extends /*public*/ ITCODParserListener {
    //public:
...
import "tileRenderer/TilesetParserV1.js"
...
SpritePtr TileSetParserV1.ReadConnectionMap(TCOD_list_t tiles) {
...
TileSetMetadataParserV1.TileSetMetadataParserV1(): parser(), metadata() {
    SetupTilesetParser(parser);
