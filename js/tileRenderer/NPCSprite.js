...
NPCSprite.NPCSprite(SpritePtr sprite): sprites(),
    weaponOverlays(),
    equipmentAware(false),
    paperdoll(false),
    weaponTypeNames(),
...
NPCSprite.NPCSprite(const std.vector < SpritePtr > & s,
        const std.vector < std.string > & weaponTypes,
            const std.vector < std.string > & armourTypes): sprites(s),
    weaponOverlays(),
    equipmentAware(true),
    paperdoll(false),
...
NPCSprite.NPCSprite(const std.vector < SpritePtr > & s,
        const std.vector < SpritePtr > & weaps,
            const std.vector < std.string > & weaponTypes,
                const std.vector < std.string > & armourTypes): sprites(s),
