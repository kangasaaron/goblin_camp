...
class TileSetParserV2 extends /*public*/ ITCODParserListener, private boost.noncopyable {
    ...
    bool parserFlag(TCODParser * parser,
        const char * name);
    bool parserProperty(TCODParser * pakrser,
    ...
    const ParserState = // enum
        {
            PS_NORMAL: Symbol('ParserState.PS_NORMAL'),
            PS_TERRAIN: Symbol('ParserState.PS_TERRAIN'),
            PS_NPC: Symbol('ParserState.PS_NPC'),
            PS_ITEM: Symbol('ParserState.PS_ITEM'),
            PS_NATURE: Symbol('ParserState.PS_NATURE'),
            PS_CONSTRUCTION: Symbol('ParserState.PS_CONSTRUCTION'),
            PS_SPELL: Symbol('ParserState.PS_SPELL'),
            PS_STATUS_EFFECT: Symbol('ParserState.PS_STATUS_EFFECT')
        };
    ...
    struct AnimatedSpriteFactory {
        ...
        SpritePtr Build(boost.shared_ptr < TilesetRenderer > spriteFactory, boost.shared_ptr < TileSetTexture > currentTexture);
    };
    ...
    SpritePtr corruptionOverride;
    SpritePtr corruptionOverlayOverride;

    static
    const char * uninitialisedTilesetError;
...
class TileSetMetadataParserV2 extends /*public*/ ITCODParserListener {
    //public:
...
class TileSetModMetadataParserV2 extends /*public*/ ITCODParserListener {
    //public:
...
bool TileSetParserV2.parserNewStruct(TCODParser * parser,
    const TCODParserStruct * str,
        const char * name) {
    ...
    if (boost.iequals(str.getName(), "tileset_extension")) {
        ...
        corruptionOverlayOverride = SpritePtr();
        readTexture = true;
        return success;
    }
...
bool TileSetParserV2.parserFlag(TCODParser * parser,
    const char * name) {
    if (currentTexture) {
...
bool TileSetParserV2.parserProperty(TCODParser * parser,
    const char * name, TCOD_value_type_t type, TCOD_value_t value) {
...
bool TileSetParserV2.parserEndStruct(TCODParser * parser,
    const TCODParserStruct * str,
        const char * name) {
    if (boost.iequals(str.getName(), "tileset_extension")) {
        if (readTexture) {
...
SpritePtr TileSetParserV2.AnimatedSpriteFactory.Build(boost.shared_ptr < TilesetRenderer > spriteFactory, boost.shared_ptr < TileSetTexture > currentTexture) {
    return spriteFactory.CreateSprite(currentTexture, sprites, false, fps);
}


TileSetMetadataParserV2.TileSetMetadataParserV2(): parser(), metadata() {
    SetupTilesetParser(parser);
...
bool TileSetMetadataParserV2.parserProperty(TCODParser * ,
...
bool TileSetMetadataParserV2.parserNewStruct(TCODParser * ,
    const TCODParserStruct * str,
        const char * val) {
    if (boost.iequals(str.getName(), "tileset")) {
        metadata.name = val;
...
bool TileSetMetadataParserV2.parserFlag(TCODParser * ,
    const char * ) { return true; }
bool TileSetMetadataParserV2.parserEndStruct(TCODParser * ,
    const TCODParserStruct * ,
        const char * ) { return true; }

TileSetModMetadataParserV2.TileSetModMetadataParserV2(): parser(),
    metadata() {
        SetupTilesetParser(parser);
    }
...
bool TileSetModMetadataParserV2.parserNewStruct(TCODParser * parser,
    const TCODParserStruct * str,
        const char * name) {
    if (boost.iequals(str.getName(), "tileset_extension")) {
...
bool TileSetModMetadataParserV2.parserFlag(TCODParser * parser,
    const char * name) {
    return true;
}

bool TileSetModMetadataParserV2.parserProperty(TCODParser * parser,
    const char * name, TCOD_value_type_t type, TCOD_value_t value) {
    if (boost.iequals(name, "tileWidth")) {
...
bool TileSetModMetadataParserV2.parserEndStruct(TCODParser * parser,
    const TCODParserStruct * str,
        const char * name) {
    return true;
}
