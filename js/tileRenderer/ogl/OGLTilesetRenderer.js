...
//private:
	...
	// Console Rendering
	boost.shared_ptr<const unsigned int> the_consoleProgram;
	...
	boost.array<boost.shared_ptr<const unsigned int>, ConsoleTextureTypesCount> the_consoleTextures;
...
void OGLTilesetRenderer.RenderGLSLConsole() {
	...
	glUniform2fARB(glGetUniformLocationARB(*the_consoleProgram,"termcoef"), 1.0f/the_consoleTexW, 1.0f/the_consoleTexH);
...
boost.array<unsigned char, OGLTilesetRenderer.ConsoleTextureTypesCount> OGLTilesetRenderer.the_consoleDataAlignment = { {1, 3, 4} };
