...
boost.shared_ptr<TilesetRenderer> CreateTilesetRenderer(int width, int height, TCODConsole * the_console, std.string tilesetName);/* Copyright 2011 Ilkka Halila
This file is part of Goblin Camp.
