...
const BuildResult { // enum
	BUILD_NOMATERIAL: -99999
};

typedef int ConstructionType;

const  ConstructionTag ={ //enum
	STOCKPILE: Symbol('ConstructionTag.STOCKPILE'),
	FARMPLOT: Symbol('ConstructionTag.FARMPLOT'),
	DOOR: Symbol('ConstructionTag.DOOR'),
	WALL: Symbol('ConstructionTag.WALL'),
	BED: Symbol('ConstructionTag.BED'),
	WORKSHOP: Symbol('ConstructionTag.WORKSHOP'),
	FURNITURE: Symbol('ConstructionTag.FURNITURE'),
	CENTERSCAMP: Symbol('ConstructionTag.CENTERSCAMP'),
	SPAWNINGPOOL: Symbol('ConstructionTag.SPAWNINGPOOL'),
	BRIDGE: Symbol('ConstructionTag.BRIDGE'),
	TRAP: Symbol('ConstructionTag.TRAP'),
	RANGEDADVANTAGE: Symbol('ConstructionTag.RANGEDADVANTAGE'),
	PERMANENT: Symbol('ConstructionTag.PERMANENT'),
	TAGCOUNT: Symbol('ConstructionTag.TAGCOUNT')
};
...
class ConstructionListener  extends /*public*/ ITCODParserListener {
