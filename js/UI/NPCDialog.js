...
class NPCDialog  extends /*public*/ UIContainer {
//public:
	NPCDialog();
...
void NPCDialog.DrawNPC(std.pair<int, boost.shared_ptr<NPC> > npci, int i, int x, int y, int width, bool selected, TCODConsole* the_console) {
