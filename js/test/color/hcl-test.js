...
tape("hcl(…) exposes h, c, and l channel values", function (test) {
  ...
  tape(
    "hcl(…) returns defined hue and undefined chroma for black and white",
  function (test) {
...
tape(
  "hcl.toString() converts to RGB and formats as hexadecimal",
    function (test) {
...
tape("hcl.toString() reflects h, c and l channel values", function (test) {
 ...
 ta pe("hcl.toString() treats undefined opacity as 1", function (test) {
    var c = color.hcl("#abc");
    c.opacity = NaN;
...
tape("hcl(h, c, l) does not clamp l channel value", function (test) {
 ...
 ta pe("hcl(h, c, l) coerces channel values to numbers", function (test) {
...
tape(
    "hcl(format) parses the specified format and converts to HCL",
    function (test) {
    test.hclEqual(
      color.hcl("#abcdef"),
      254.0079700170605,
 ...
 ta pe(
  "hcl(format) returns undefined channel values for unknown formats",
  function (test) {
...
tape("hcl(lab) returns h = NaN if a and b are zero", function (test) {
  ...
  tape("hcl(rgb) converts from RGB", function (test) {
    test.hclEqual(
    color.hcl(color.rgb(255, 0, 0, 0.4)),
    40.85261277607024,
    106.83899941284552,
      54.29173376861782,
     0. 4
...
tape(
  "hcl(color) converts from another colorspace via color.rgb()",
    function (test) {
      function TestColor() {}
